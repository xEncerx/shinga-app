      ...
      appBar: AppBar(
        ...
        leading: AppTheme.isDebug
            ? IconButton(
                ...
                icon: const HugeIcon(icon: HugeIcons.strokeRoundedTvFix),
              )
            : null,
        actionsPadding: const EdgeInsets.only(right: 10),
        actions: [
          IconButton(
            icon: const HugeIcon(icon: HugeIcons.strokeRoundedLogout02),
            ...
            return ListView(
              ...
              children: [
                ...
                SwitchSettingsTile(
                  ...
                  prefixIcon: HugeIcons.strokeRoundedCards02,
                  onChanged: (value) {
                ...
                if (AppTheme.isMobile)
                  SwitchSettingsTile(
                    ...
                    prefixIcon: HugeIcons.strokeRoundedWebDesign01,
                    onChanged: (value) {
